...
const financeCourses = [
  ...
  { title: 'Business Economics', description: 'Understand micro and macroeconomics, market structures, and economic policies for business.', image: courseBusinessEconImg, duration: '2 months', audience: 'Commerce Graduates' },
